    ...
    <main className="flex-1 container mx-auto mt-4 px-4">
      ...
      <section className="mb-8">
        ...
        <div className="shadow-md rounded-lg p-4 mb-4">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center">
              <Image width="32" height="32" className="w-8 mr-2 rounded-full" src="https://fesp-api.koyeb.app/market/files/openmarket/user-muzi.png" alt="무지 프로필 이미지" />
              <Link href="" className="text-orange-400">
                무지
              </Link>
            </div>
        ...
        <div className="p-4 border border-gray-200 rounded-lg">
          ...
          <form action="#">
            ...
            <button type="submit" className="bg-orange-500 py-1 px-4 text-sm text-white font-semibold ml-2 hover:bg-amber-400 rounded">
              댓글 등록
            </button>
          </form>
        </div>
